...
import { Container, Flex, Text, Skeleton,Box,Card, Avatar,Separator ,HoverCard,Heading} from '@radix-ui/themes'
...
export const Interest = () => {
    ...
    useEffect(() => {
        const getBrand = async () => {
            setLoad(true)
            try {
                const response = await fetch(`${import.meta.env.VITE_API_URL}/top-by-interest`)
            ...
            <>
                ...
                <div className='flex flex-wrap md:justify-center gap-4 md:gap-3 lg:gap-14 lg:mx-4 mt-10'>
                    ...
                    <Text key={index}>
                        <HoverCard.Root>
                            <HoverCard.Trigger>
                                <Link to={`/phone/${data.slug}/detail`} 
                                    state={{ brand_slug: null, page: 'interest' }}
                                    >
                                    <Box>
